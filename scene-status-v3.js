(() => {
  ...
  function updateSchedule() {
    ...
    replaceText(
      panel,
      'Scener 3A, 5A og 8A efter vejr, sigt og lys. Scene 6A og 7A er filmet.',
      'Scener 5A og 8A efter vejr, sigt og lys. Scene 3A, 6A og 7A er filmet.'
    );
    replaceText(
      panel,
      'Optag scene 3A i Fuglafjørður eller Vestmanna samt de resterende billeder af lille bygd og ø-landskaber. Klaksvík må ikke bruges til droneflyvning. Scene 6A og 7A er allerede filmet.',
      'Scene 3A er filmet i Klaksvík som oprindeligt planlagt. Fuglafjørður og Vestmanna var plan B. De resterende droneoptagelser er scene 5A og 8A.'
    );
    replaceText(
      panel,
      ...
      'Scene 3A er filmet i Klaksvík som oprindeligt planlagt. Fuglafjørður og Vestmanna var plan B. Scene 6A og 7A er også filmet. De resterende droneoptagelser er scene 5A og 8A.'
    );
  }
