(() => {
  ...
  const groups = [
    ...
    {
      location: 'Ø-landskab',
      status: 'Afventer planlægning',
      scenes: [['8A', 'Dronen stiger og afslører det færøske ølandskab.']]
    },
    {
  ...
  function markup() {
    return `
      <section id="producer-scene-status" data-version="${VERSION}">
        ...
        <div class="producer-filmed"><b>Filmet:</b> 3A · Klaksvík om natten, 6A · vandkraft og 7A · vindmøller.</div>
      </section>
    `;
  }
